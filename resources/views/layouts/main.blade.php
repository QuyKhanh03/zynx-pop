                        ...
                        <div class="topbar d-flex align-items-stretch flex-shrink-0">
                            ...
                            <div class="d-flex align-items-stretch" id="kt_header_user_menu_toggle">
                                <div
                                    ...
                                    <img src="{{ auth()->user()->avatar ?? asset('theme/assets/media/avatars/blank.png') }}" alt="metronic"/>
                                </div>
                                <div
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            <div class="symbol symbol-50px me-5">
                                                <img alt="Logo"
                                                     src="{{ auth()->user()->avatar ?? asset('theme/assets/media/avatars/blank.png') }}"/>
                                            </div>
                                    ...
                                    <div class="menu-item px-5">
                                        <a href="{{ route('admin.users.update-profile') }}" class="menu-link px-5">My Profile</a>
                                    </div>
                                    ...
                                    <div class="menu-item px-5">
                                        @if(auth()->check())
                                            <form method="post" action="{{ route('logout') }}">
                                                @csrf
                                                <button type="submit" class="btn w-100 d-flex justify-content-start menu-link px-5">Sign Out</button>
                                            </form>
                                        @endif
                                    </div>
                                </div>
