                        ...
                        <div class="col-md-6">
                            <form action="{{ route('admin.offers.store') }}" method="POST">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter offer name" value="{{ old('name') }}" >
                                    <span class="text-danger">{{ $errors->first('name') }}</span>
                                </div>
                                <div class="mb-5">
                                    <label for="direct_link" class="form-label required">Direct Link</label>
                                    <input type="text" class="form-control" id="direct_link" name="direct_link" placeholder="Enter direct link" value="{{ old('direct_link') }}">
                                    <span class="text-danger">{{ $errors->first('direct_link') }}</span>
                                </div>
                                <div class="mb-5">
                                    <label for="partner" class="form-label required">Partner</label>
                                    <input type="text" class="form-control" id="partner" name="partner" placeholder="Enter partner name" value="{{ old('partner') }}">
